                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="../index.php">
                                <img src="../images/dlr.png" height=300 width=300 alt="CoolAdmin">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="registo.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="femail" placeholder="Email" required>
                                </div>
                                <div class="form-group">
                                    <label>First and Last Name</label>
                                    <input class="au-input au-input--full" type="name" name="fname" placeholder="First and Last name" required>
                                </div>
                                <div class="form-group">
